...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251013212425_AddUniqueCol1")]
    partial class AddUniqueCol1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.TabDays", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PrgDepartmentInfoTabDays", b =>
                {
                    b.Property<int>("PrgDepartmentInfosId")
                        .HasColumnType("integer");

                    b.Property<int>("TabDaysId")
                        .HasColumnType("integer");

                    b.HasKey("PrgDepartmentInfosId", "TabDaysId");

                    b.HasIndex("TabDaysId");

                    b.ToTable("PrgDepartmentInfoTabDays");
                });
            ...
            modelBuilder.Entity("PrgDepartmentInfoTabDays", b =>
                {
                    b.HasOne("Domain.Entities.PrgDepartmentInfo", null)
                        .WithMany()
                        .HasForeignKey("PrgDepartmentInfosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.TabDays", null)
                        .WithMany()
                        .HasForeignKey("TabDaysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
