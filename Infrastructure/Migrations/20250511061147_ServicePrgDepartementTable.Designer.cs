...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250511061147_ServicePrgDepartementTable")]
    partial class ServicePrgDepartementTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrgDepartmentInfoTabServices", b =>
                {
                    ...
                    b.HasKey("PrgDepartmentInfosId", "TabServicesId");

                    b.HasIndex("TabServicesId");

                    b.ToTable("PrgDepartmentInfoTabServices");
                });
            ...
            modelBuilder.Entity("PrgDepartmentInfoTabServices", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.TabServices", null)
                        .WithMany()
                        .HasForeignKey("TabServicesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
