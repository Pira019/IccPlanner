...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260430192642_starter")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DepartmentPostes", b =>
                {
                    ...
                    b.HasKey("DepartmentsId", "PostesId");

                    b.HasIndex("PostesId");

                    b.ToTable("DepartmentPostes");
                });

            modelBuilder.Entity("Domain.Entities.AppSettingEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Department", b =>
                {
                    ...
                    b.Property<int?>("RecurrentDaysAhead")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.DepartmentMemberPost", b =>
                {
                    ...
                    b.Property<bool>("IndAutoPlanning")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Entities.DepartmentProgram", b =>
                {
                    ...
                    b.HasIndex("ProgramId", "DepartmentId", "IndRecurent")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.Invitation", b =>
                {
                    ...
                    b.Property<bool>("IndAct")
                        .HasColumnType("boolean");

                    b.Property<bool>("IndUsed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Entities.PlanningPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.PublishedPlanning", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SourcePlanningId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DepartmentPostes", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Poste", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Planning", b =>
                {
                    b.HasOne("Domain.Entities.Availability", "Availability")
                        .WithOne("Planning")
                        .HasForeignKey("Domain.Entities.Planning", "AvailabilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.PlanningPeriod", "PlanningPeriod")
                        .WithMany("Plannings")
            ...
            modelBuilder.Entity("Domain.Entities.PlanningPeriod", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Member", "PublishedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.DepartmentProgram", b =>
                {
                    ...
                    b.Navigation("PrgDepartmentInfos");
                });
