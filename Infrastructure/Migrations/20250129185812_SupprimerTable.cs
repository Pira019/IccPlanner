...
{
    /// <inheritdoc />
    public partial class SupprimerTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {

            migrationBuilder.Sql("DROP TABLE IF EXISTS \"RoleUser\" CASCADE;");

            // Supprimer la table Profiles seulement si elle existe
